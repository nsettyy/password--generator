...
function generatePassword() {
  ...
  var length = parseInt(
    window.prompt(
      "Please choose the length of your password. Must be atleast 8 characters and no longer than 128 charcters."
    )
  );
  if (length >= 8 && length <= 128) {
    ...
    window.alert(
      "Please choose a charcter length greater than 8 characters and less than 128 charcters."
    );
